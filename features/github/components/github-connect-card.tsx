...
import { getGithubAppInstallUrl } from "@/features/github/utils/github-app";
...
export function GithubConnectCard({
    ...
    const installUrl = getGithubAppInstallUrl(userId);
    ...
    return (
        <div className="flex flex-1 flex-col gap-6 p-6">
            <Card
                className={cn("max-w-2xl transition-colors", cardBorderClass)}
            >
                <CardHeader>
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Install the Chai reviewer app on your GitHub
                                    account or organization to access public and
